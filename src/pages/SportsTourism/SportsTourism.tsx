          ...
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            <AnimatedSection>
              ...
              <h2 className="font-heading font-black text-3xl sm:text-4xl lg:text-[2.6rem] text-[#0A2540] tracking-tight leading-tight mb-3">
                Our{' '}
                <span className="bg-gradient-to-r from-[#0052CC] to-[#7928CA] bg-clip-text text-transparent">
                  Past Sport Tourism
                </span>{' '}
                Experiences
              </h2>
        ...
        <div className="container-hs relative z-10 text-center max-w-3xl mx-auto px-4">
          <AnimatedSection>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3.5 sm:gap-4">
              ...
              {/* WhatsApp Button (Purple/Indigo Pill) */}
              <a
                href={`https://wa.me/${siteConfig.contact.whatsapp}?text=${encodeURIComponent(
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 px-7 sm:px-8 py-3.5 sm:py-4 rounded-full bg-[#6D28D9] hover:bg-[#5b21b6] text-white font-bold text-xs sm:text-sm tracking-wide shadow-lg hover:shadow-purple-500/25 hover:scale-105 active:scale-95 transition-all duration-300"
              >
